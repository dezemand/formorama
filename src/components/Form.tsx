...
import {FormContextValue, FormContext} from "../contexts/FormContext";
import {BLUR_EVENT, CHANGE_EVENT, ERROR_EVENT, FOCUS_EVENT} from "../events";

const getValuesObject = (values: Map<string, any>): {[key: string]: any} => {
...
export interface FormProps {
    ...
    onError: (errors: {[key: string]: any}, values: {[key: string]: any}) => Promise<void>;
    validate: (values: {[key: string]: any}, fields: string[] | null) => Promise<{[key: string]: any}>;
}
