import { ComponentClass, createElement, FC, FunctionComponent, ReactNode } from "react";
...
interface ArrayFormItemsProps<ParentValues extends Array<ParentValues>> {
  component?:
    | FunctionComponent<ArrayFormItemsChildrenParams<ParentValues[0]>>
    | ComponentClass<ArrayFormItemsChildrenParams<ParentValues[0]>>
    | string;
...
export function ArrayFormItems<ParentValues extends Array<ParentValues> = any[], RootValues = any>({
  children,
  component,
  getKey
}: ArrayFormItemsProps<ParentValues>): ReturnType<FC<ArrayFormItemsProps<ParentValues>>> {
